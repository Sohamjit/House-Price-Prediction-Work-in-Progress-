...
df_train[,total_area := (sqft_living +  sqft_lot + sqft_above + sqft_basement)]
...
df_train[,avg_area := (total_area / (bedrooms + bathrooms))]
...
df = df_train[,c("zipcode" , "lat","long")]
